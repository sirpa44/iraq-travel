...
class ArticleControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'article[creationDate]' => 'Testing',
            'article[updatedDate]' => 'Testing',
            'article[introductionTitle]' => 'Testing',
            'article[introductionText]' => 'Testing',
    ...
    public function testShow(): void
    {
        ...
        $fixture->setIntroductionTitle('My Title');
        $fixture->setIntroductionText('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'article[creationDate]' => 'Something New',
            'article[updatedDate]' => 'Something New',
            'article[introductionTitle]' => 'Something New',
            'article[introductionText]' => 'Something New',
        ...
        self::assertSame('Something New', $fixture[0]->getIntroductionTitle());
        self::assertSame('Something New', $fixture[0]->getIntroductionText());
